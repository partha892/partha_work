...
const Biulder4 = () => {
  return (
    <div className="card-section1">
      ...
      {/* Card 2 */}
      <div className="card1">
        <h2 className="card-title">CDK Resposive Builder: </h2>
        <p className="card-description">An extensive library of widgets and apps, and detailed step-by-step guides</p>
